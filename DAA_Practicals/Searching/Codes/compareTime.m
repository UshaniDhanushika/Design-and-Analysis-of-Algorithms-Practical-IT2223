...
%% If target index is in first half linear search is faster. 
%% If target index is in the middle both are same.
%% If target index is in last half binary search is faster. 
...
target = 500;  %% target is not index it is the value
